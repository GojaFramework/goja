...
public final class Unit<A>
    ...
    /**
     * <p> Create tuple from array. Array has to have exactly one element. </p>
     *
    ...
    /**
     * <p> Create tuple from collection. Collection has to have exactly one element. </p>
     *
    ...
    public static <X> Unit<X> fromCollection(final Collection<X> collection) {
        ...
        if (collection.size() != 1) {
            throw new IllegalArgumentException(
                    "Collection must have exactly 1 element in order to create a Unit. Size is "
                            + collection.size());
        }
    ...
    /**
     * <p> Create tuple from iterable. Iterable has to have exactly one element. </p>
     *
    ...
    private static <X> Unit<X> fromIterable(final Iterable<X> iterable, int index,
    ...
    public <X0, X1, X2> Quartet<X0, X1, X2, A> addAt0(final X0 value0, final X1 value1,
                                                      final X2 value2) {
        return new Quartet<X0, X1, X2, A>(
                value0, value1, value2, this.val0);
    }

    public <X0, X1, X2> Quartet<A, X0, X1, X2> addAt1(final X0 value0, final X1 value1,
                                                      final X2 value2) {
        return new Quartet<A, X0, X1, X2>(
                this.val0, value0, value1, value2);
    }

    public <X0, X1, X2, X3> Quintet<X0, X1, X2, X3, A> addAt0(final X0 value0, final X1 value1,
                                                              final X2 value2, final X3 value3) {
        return new Quintet<X0, X1, X2, X3, A>(
                value0, value1, value2, value3, this.val0);
    }

    public <X0, X1, X2, X3> Quintet<A, X0, X1, X2, X3> addAt1(final X0 value0, final X1 value1,
                                                              final X2 value2, final X3 value3) {
        return new Quintet<A, X0, X1, X2, X3>(
                this.val0, value0, value1, value2, value3);
    }

    public <X0, X1, X2, X3, X4> Sextet<X0, X1, X2, X3, X4, A> addAt0(final X0 value0, final X1 value1,
    ...
    public <X0, X1, X2, X3, X4> Sextet<A, X0, X1, X2, X3, X4> addAt1(final X0 value0, final X1 value1,
                                                                     final X2 value2, final X3 value3, final X4 value4) {
        return new Sextet<A, X0, X1, X2, X3, X4>(
                this.val0, value0, value1, value2, value3, value4);
    }

    public <X0, X1, X2, X3, X4, X5> Septet<X0, X1, X2, X3, X4, X5, A> addAt0(final X0 value0,
    ...
    public <X0, X1, X2, X3, X4, X5> Septet<A, X0, X1, X2, X3, X4, X5> addAt1(final X0 value0,
                                                                             final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
        return new Septet<A, X0, X1, X2, X3, X4, X5>(
                this.val0, value0, value1, value2, value3, value4, value5);
    }

    public <X0, X1, X2, X3, X4, X5, X6> Octet<X0, X1, X2, X3, X4, X5, X6, A> addAt0(final X0 value0,
                                                                                    final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5,
                                                                                    final X6 value6) {
    ...
    public <X0, X1, X2, X3, X4, X5, X6> Octet<A, X0, X1, X2, X3, X4, X5, X6> addAt1(final X0 value0,
                                                                                    final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5,
                                                                                    final X6 value6) {
    ...
    public <X0, X1, X2, X3, X4, X5, X6, X7, X8> Decade<X0, X1, X2, X3, X4, X5, X6, X7, X8, A> addAt0(
            final X0 value0, final X1 value1, final X2 value2, final X3 value3, final X4 value4,
            final X5 value5, final X6 value6, final X7 value7, final X8 value8) {
    ...
    public <X0, X1, X2, X3, X4> Sextet<X0, X1, X2, X3, X4, A> addAt0(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt0(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(),
                tuple.getValue4());
    }

    public <X0, X1, X2, X3, X4> Sextet<A, X0, X1, X2, X3, X4> addAt1(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt1(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(),
                tuple.getValue4());
    }
    ...
    public <X0, X1, X2> Quartet<A, X0, X1, X2> add(final X0 value0, final X1 value1,
                                                   final X2 value2) {
    ...
    public <X0, X1, X2, X3> Quintet<A, X0, X1, X2, X3> add(final X0 value0, final X1 value1,
                                                           final X2 value2, final X3 value3) {
    ...
    public <X0, X1, X2, X3, X4> Sextet<A, X0, X1, X2, X3, X4> add(final X0 value0, final X1 value1,
                                                                  final X2 value2, final X3 value3, final X4 value4) {
        return addAt1(value0, value1, value2, value3, value4);
    }

    public <X0, X1, X2, X3, X4> Sextet<A, X0, X1, X2, X3, X4> add(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt1(tuple);
    }

    public <X0, X1, X2, X3, X4, X5> Septet<A, X0, X1, X2, X3, X4, X5> add(final X0 value0,
                                                                          final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
        return addAt1(value0, value1, value2, value3, value4, value5);
    }

    public <X0, X1, X2, X3, X4, X5> Septet<A, X0, X1, X2, X3, X4, X5> add(
            final Sextet<X0, X1, X2, X3, X4, X5> tuple) {
        return addAt1(tuple);
    }

    public <X0, X1, X2, X3, X4, X5, X6> Octet<A, X0, X1, X2, X3, X4, X5, X6> add(final X0 value0,
                                                                                 final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5,
                                                                                 final X6 value6) {
