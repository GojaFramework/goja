...
import goja.core.tuples.valueintf.*;

import java.util.Collection;
import java.util.Iterator;

/**
 * <p> A tuple of five elements. </p>
 *
...
public final class Quintet<A, B, C, D, E>
    ...
    public static <A, B, C, D, E> Quintet<A, B, C, D, E> with(final A value0, final B value1,
                                                              final C value2, final D value3, final E value4) {
        return new Quintet<A, B, C, D, E>(value0, value1, value2, value3, value4);
    }

    /**
     * <p> Create tuple from array. Array has to have exactly five elements. </p>
     *
    ...
    public static <X> Quintet<X, X, X, X, X> fromArray(final X[] array) {
        ...
        if (array.length != 5) {
            throw new IllegalArgumentException(
                    "Array must have exactly 5 elements in order to create a Quintet. Size is "
                            + array.length);
        }
    ...
    /**
     * <p> Create tuple from collection. Collection has to have exactly five elements. </p>
     *
    ...
    /**
     * <p> Create tuple from iterable. Iterable has to have exactly five elements. </p>
     *
    ...
    private static <X> Quintet<X, X, X, X, X> fromIterable(final Iterable<X> iterable, int index,
        ...
        if (iter.hasNext() && exactSize) {
            throw new IllegalArgumentException(
                    "Iterable must have exactly 5 available elements in order to create a Quintet.");
        }
    ...
    public <X0, X1, X2, X3, X4> Decade<A, X0, X1, X2, X3, X4, B, C, D, E> addAt1(final X0 value0,
                                                                                 final X1 value1, final X2 value2, final X3 value3, final X4 value4) {
    ...
    public <X0, X1, X2, X3, X4> Decade<A, B, X0, X1, X2, X3, X4, C, D, E> addAt2(final X0 value0,
                                                                                 final X1 value1, final X2 value2, final X3 value3, final X4 value4) {
    ...
    public <X0, X1, X2, X3, X4> Decade<A, B, C, X0, X1, X2, X3, X4, D, E> addAt3(final X0 value0,
                                                                                 final X1 value1, final X2 value2, final X3 value3, final X4 value4) {
    ...
    public <X0, X1, X2, X3, X4> Decade<A, B, C, D, X0, X1, X2, X3, X4, E> addAt4(final X0 value0,
                                                                                 final X1 value1, final X2 value2, final X3 value3, final X4 value4) {
    ...
    public <X0, X1, X2, X3, X4> Decade<A, B, C, D, E, X0, X1, X2, X3, X4> addAt5(final X0 value0,
                                                                                 final X1 value1, final X2 value2, final X3 value3, final X4 value4) {
    ...
    public <X0, X1, X2> Octet<A, B, C, D, E, X0, X1, X2> add(final X0 value0, final X1 value1,
                                                             final X2 value2) {
    ...
    public <X0, X1, X2, X3> Ennead<A, B, C, D, E, X0, X1, X2, X3> add(final X0 value0,
                                                                      final X1 value1, final X2 value2, final X3 value3) {
        return addAt5(value0, value1, value2, value3);
    }

    public <X0, X1, X2, X3> Ennead<A, B, C, D, E, X0, X1, X2, X3> add(
            final Quartet<X0, X1, X2, X3> tuple) {
        return addAt5(tuple);
    }

    public <X0, X1, X2, X3, X4> Decade<A, B, C, D, E, X0, X1, X2, X3, X4> add(final X0 value0,
                                                                              final X1 value1, final X2 value2, final X3 value3, final X4 value4) {
        return addAt5(value0, value1, value2, value3, value4);
    }

    public <X0, X1, X2, X3, X4> Decade<A, B, C, D, E, X0, X1, X2, X3, X4> add(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt5(tuple);
    }
