...
public final class Octet<A, B, C, D, E, F, G, H>
    ...
    public static <A, B, C, D, E, F, G, H> Octet<A, B, C, D, E, F, G, H> with(final A value0,
                                                                              final B value1, final C value2, final D value3, final E value4, final F value5,
                                                                              final G value6, final H value7) {
        return new Octet<A, B, C, D, E, F, G, H>(value0, value1, value2, value3, value4, value5, value6,
                value7);
    }

    /**
     * <p> Create tuple from array. Array has to have exactly eight elements. </p>
     *
    ...
    public static <X> Octet<X, X, X, X, X, X, X, X> fromArray(final X[] array) {
        ...
        if (array.length != 8) {
            throw new IllegalArgumentException(
                    "Array must have exactly 8 elements in order to create an Octet. Size is "
                            + array.length);
        }
    ...
    /**
     * <p> Create tuple from collection. Collection has to have exactly eight elements. </p>
     *
    ...
    /**
     * <p> Create tuple from iterable. Iterable has to have exactly eight elements. </p>
     *
    ...
    private static <X> Octet<X, X, X, X, X, X, X, X> fromIterable(final Iterable<X> iterable,
