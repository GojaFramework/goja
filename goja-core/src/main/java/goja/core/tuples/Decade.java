...
public final class Decade<A, B, C, D, E, F, G, H, I, J>
    ...
    public static <A, B, C, D, E, F, G, H, I, J> Decade<A, B, C, D, E, F, G, H, I, J> with(
        ...
        return new Decade<A, B, C, D, E, F, G, H, I, J>(value0, value1, value2, value3, value4, value5,
                value6, value7, value8, value9);
    }

    /**
     * <p> Create tuple from array. Array has to have exactly ten elements. </p>
     *
    ...
    public static <X> Decade<X, X, X, X, X, X, X, X, X, X> fromArray(final X[] array) {
        ...
        if (array.length != 10) {
            throw new IllegalArgumentException(
                    "Array must have exactly 10 elements in order to create a Decade. Size is "
                            + array.length);
        }
    ...
    /**
     * <p> Create tuple from collection. Collection has to have exactly ten elements. </p>
     *
     * @param <X>        the collection component type
     * @param collection the collection to be converted to a tuple
     * @return the tuple
     */
    public static <X> Decade<X, X, X, X, X, X, X, X, X, X> fromCollection(
            final Collection<X> collection) {
        return fromIterable(collection);
    }

    /**
     * <p> Create tuple from iterable. Iterable has to have exactly ten elements. </p>
     *
    ...
    private static <X> Decade<X, X, X, X, X, X, X, X, X, X> fromIterable(final Iterable<X> iterable,
        ...
        if (iter.hasNext() && exactSize) {
            throw new IllegalArgumentException(
                    "Iterable must have exactly 10 available elements in order to create a Decade.");
        }
