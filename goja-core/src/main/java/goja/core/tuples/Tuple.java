...
/**
 * <p> Abstract base class for all tuple classes. </p>
 *
...
public abstract class Tuple implements Iterable<Object>, Serializable, Comparable<Tuple> {
    ...
    /**
     * @deprecated Will be removed in 1.4. The "size" parameter is of no use at this level, so use the
     * simpler Tuple(values) constructor instead.
     */
    @Deprecated
    ...
    /**
     * <p> Return the size of the tuple. </p>
     *
    ...
    /**
     * <p> Get the value at a specific position in the tuple. This method has to return object, so
     * using it you will lose the type-safety you get with the <tt>getValueX()</tt> methods. </p>
     *
