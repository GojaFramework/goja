...
public final class Triplet<A, B, C>
    ...
    /**
     * <p> Create tuple from array. Array has to have exactly three elements. </p>
     *
    ...
    public static <X> Triplet<X, X, X> fromArray(final X[] array) {
        ...
        if (array.length != 3) {
            throw new IllegalArgumentException(
                    "Array must have exactly 3 elements in order to create a Triplet. Size is "
                            + array.length);
        }
    ...
    /**
     * <p> Create tuple from collection. Collection has to have exactly three elements. </p>
     *
    ...
    /**
     * <p> Create tuple from iterable. Iterable has to have exactly three elements. </p>
     *
    ...
    private static <X> Triplet<X, X, X> fromIterable(final Iterable<X> iterable, int index,
    ...
    public <X0, X1, X2> Sextet<X0, X1, X2, A, B, C> addAt0(final X0 value0, final X1 value1,
                                                           final X2 value2) {
        return new Sextet<X0, X1, X2, A, B, C>(
                value0, value1, value2, this.val0, this.val1, this.val2);
    }

    public <X0, X1, X2> Sextet<A, X0, X1, X2, B, C> addAt1(final X0 value0, final X1 value1,
                                                           final X2 value2) {
        return new Sextet<A, X0, X1, X2, B, C>(
                this.val0, value0, value1, value2, this.val1, this.val2);
    }

    public <X0, X1, X2> Sextet<A, B, X0, X1, X2, C> addAt2(final X0 value0, final X1 value1,
                                                           final X2 value2) {
        return new Sextet<A, B, X0, X1, X2, C>(
                this.val0, this.val1, value0, value1, value2, this.val2);
    }

    public <X0, X1, X2> Sextet<A, B, C, X0, X1, X2> addAt3(final X0 value0, final X1 value1,
                                                           final X2 value2) {
        return new Sextet<A, B, C, X0, X1, X2>(
                this.val0, this.val1, this.val2, value0, value1, value2);
    }

    public <X0, X1, X2, X3> Septet<X0, X1, X2, X3, A, B, C> addAt0(final X0 value0, final X1 value1,
    ...
    public <X0, X1, X2, X3> Septet<A, X0, X1, X2, X3, B, C> addAt1(final X0 value0, final X1 value1,
                                                                   final X2 value2, final X3 value3) {
        return new Septet<A, X0, X1, X2, X3, B, C>(
                this.val0, value0, value1, value2, value3, this.val1, this.val2);
    }

    public <X0, X1, X2, X3> Septet<A, B, X0, X1, X2, X3, C> addAt2(final X0 value0, final X1 value1,
                                                                   final X2 value2, final X3 value3) {
        return new Septet<A, B, X0, X1, X2, X3, C>(
                this.val0, this.val1, value0, value1, value2, value3, this.val2);
    }

    public <X0, X1, X2, X3> Septet<A, B, C, X0, X1, X2, X3> addAt3(final X0 value0, final X1 value1,
                                                                   final X2 value2, final X3 value3) {
        return new Septet<A, B, C, X0, X1, X2, X3>(
                this.val0, this.val1, this.val2, value0, value1, value2, value3);
    }

    public <X0, X1, X2, X3, X4> Octet<X0, X1, X2, X3, X4, A, B, C> addAt0(final X0 value0,
    ...
    public <X0, X1, X2, X3, X4, X5> Ennead<A, X0, X1, X2, X3, X4, X5, B, C> addAt1(final X0 value0,
                                                                                   final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
        return new Ennead<A, X0, X1, X2, X3, X4, X5, B, C>(
                this.val0, value0, value1, value2, value3, value4, value5, this.val1, this.val2);
    }

    public <X0, X1, X2, X3, X4, X5> Ennead<A, B, X0, X1, X2, X3, X4, X5, C> addAt2(final X0 value0,
                                                                                   final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
        return new Ennead<A, B, X0, X1, X2, X3, X4, X5, C>(
                this.val0, this.val1, value0, value1, value2, value3, value4, value5, this.val2);
    }

    public <X0, X1, X2, X3, X4, X5> Ennead<A, B, C, X0, X1, X2, X3, X4, X5> addAt3(final X0 value0,
                                                                                   final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
    ...
    public <X0, X1, X2, X3, X4, X5, X6> Decade<X0, X1, X2, X3, X4, X5, X6, A, B, C> addAt0(
            final X0 value0, final X1 value1, final X2 value2, final X3 value3, final X4 value4,
            final X5 value5, final X6 value6) {
    ...
    public <X0, X1, X2, X3> Septet<X0, X1, X2, X3, A, B, C> addAt0(
            final Quartet<X0, X1, X2, X3> tuple) {
        return addAt0(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3());
    }

    public <X0, X1, X2, X3> Septet<A, X0, X1, X2, X3, B, C> addAt1(
            final Quartet<X0, X1, X2, X3> tuple) {
        return addAt1(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3());
    }

    public <X0, X1, X2, X3> Septet<A, B, X0, X1, X2, X3, C> addAt2(
            final Quartet<X0, X1, X2, X3> tuple) {
        return addAt2(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3());
    }

    public <X0, X1, X2, X3> Septet<A, B, C, X0, X1, X2, X3> addAt3(
            final Quartet<X0, X1, X2, X3> tuple) {
        return addAt3(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3());
    }

    public <X0, X1, X2, X3, X4> Octet<X0, X1, X2, X3, X4, A, B, C> addAt0(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt0(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(),
                tuple.getValue4());
    }

    public <X0, X1, X2, X3, X4> Octet<A, X0, X1, X2, X3, X4, B, C> addAt1(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt1(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(),
                tuple.getValue4());
    }

    public <X0, X1, X2, X3, X4> Octet<A, B, X0, X1, X2, X3, X4, C> addAt2(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt2(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(),
                tuple.getValue4());
    }

    public <X0, X1, X2, X3, X4> Octet<A, B, C, X0, X1, X2, X3, X4> addAt3(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt3(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(),
                tuple.getValue4());
    }
    ...
    public <X0, X1, X2, X3, X4, X5, X6> Decade<X0, X1, X2, X3, X4, X5, X6, A, B, C> addAt0(
        ...
        return addAt0(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(),
                tuple.getValue4(), tuple.getValue5(), tuple.getValue6());
    }
    ...
    public <X0, X1, X2> Sextet<A, B, C, X0, X1, X2> add(final X0 value0, final X1 value1,
                                                        final X2 value2) {
    ...
    public <X0, X1, X2, X3> Septet<A, B, C, X0, X1, X2, X3> add(final X0 value0, final X1 value1,
                                                                final X2 value2, final X3 value3) {
    ...
    public <X0, X1, X2, X3, X4> Octet<A, B, C, X0, X1, X2, X3, X4> add(final X0 value0,
                                                                       final X1 value1, final X2 value2, final X3 value3, final X4 value4) {
        return addAt3(value0, value1, value2, value3, value4);
    }

    public <X0, X1, X2, X3, X4> Octet<A, B, C, X0, X1, X2, X3, X4> add(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt3(tuple);
    }

    public <X0, X1, X2, X3, X4, X5> Ennead<A, B, C, X0, X1, X2, X3, X4, X5> add(final X0 value0,
                                                                                final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
