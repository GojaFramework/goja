...
public final class Pair<A, B>
    ...
    /**
     * <p> Create tuple from array. Array has to have exactly two elements. </p>
     *
    ...
    /**
     * <p> Create tuple from collection. Collection has to have exactly two elements. </p>
     *
    ...
    /**
     * <p> Create tuple from iterable. Iterable has to have exactly two elements. </p>
     *
    ...
    private static <X> Pair<X, X> fromIterable(final Iterable<X> iterable, int index,
    ...
    public <X0, X1, X2> Quintet<X0, X1, X2, A, B> addAt0(final X0 value0, final X1 value1,
                                                         final X2 value2) {
        return new Quintet<X0, X1, X2, A, B>(
                value0, value1, value2, this.val0, this.val1);
    }

    public <X0, X1, X2> Quintet<A, X0, X1, X2, B> addAt1(final X0 value0, final X1 value1,
                                                         final X2 value2) {
        return new Quintet<A, X0, X1, X2, B>(
                this.val0, value0, value1, value2, this.val1);
    }

    public <X0, X1, X2> Quintet<A, B, X0, X1, X2> addAt2(final X0 value0, final X1 value1,
                                                         final X2 value2) {
        return new Quintet<A, B, X0, X1, X2>(
                this.val0, this.val1, value0, value1, value2);
    }

    public <X0, X1, X2, X3> Sextet<X0, X1, X2, X3, A, B> addAt0(final X0 value0, final X1 value1,
                                                                final X2 value2, final X3 value3) {
        return new Sextet<X0, X1, X2, X3, A, B>(
                value0, value1, value2, value3, this.val0, this.val1);
    }

    public <X0, X1, X2, X3> Sextet<A, X0, X1, X2, X3, B> addAt1(final X0 value0, final X1 value1,
                                                                final X2 value2, final X3 value3) {
        return new Sextet<A, X0, X1, X2, X3, B>(
                this.val0, value0, value1, value2, value3, this.val1);
    }

    public <X0, X1, X2, X3> Sextet<A, B, X0, X1, X2, X3> addAt2(final X0 value0, final X1 value1,
                                                                final X2 value2, final X3 value3) {
        return new Sextet<A, B, X0, X1, X2, X3>(
                this.val0, this.val1, value0, value1, value2, value3);
    }

    public <X0, X1, X2, X3, X4> Septet<X0, X1, X2, X3, X4, A, B> addAt0(final X0 value0,
    ...
    public <X0, X1, X2, X3, X4> Septet<A, X0, X1, X2, X3, X4, B> addAt1(final X0 value0,
                                                                        final X1 value1, final X2 value2, final X3 value3, final X4 value4) {
        return new Septet<A, X0, X1, X2, X3, X4, B>(
                this.val0, value0, value1, value2, value3, value4, this.val1);
    }

    public <X0, X1, X2, X3, X4> Septet<A, B, X0, X1, X2, X3, X4> addAt2(final X0 value0,
                                                                        final X1 value1, final X2 value2, final X3 value3, final X4 value4) {
        return new Septet<A, B, X0, X1, X2, X3, X4>(
                this.val0, this.val1, value0, value1, value2, value3, value4);
    }

    public <X0, X1, X2, X3, X4, X5> Octet<X0, X1, X2, X3, X4, X5, A, B> addAt0(final X0 value0,
    ...
    public <X0, X1, X2, X3, X4, X5> Octet<A, X0, X1, X2, X3, X4, X5, B> addAt1(final X0 value0,
                                                                               final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
        return new Octet<A, X0, X1, X2, X3, X4, X5, B>(
                this.val0, value0, value1, value2, value3, value4, value5, this.val1);
    }

    public <X0, X1, X2, X3, X4, X5> Octet<A, B, X0, X1, X2, X3, X4, X5> addAt2(final X0 value0,
                                                                               final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
    ...
    public <X0, X1, X2, X3, X4, X5, X6, X7> Decade<X0, X1, X2, X3, X4, X5, X6, X7, A, B> addAt0(
            final X0 value0, final X1 value1, final X2 value2, final X3 value3, final X4 value4,
            final X5 value5, final X6 value6, final X7 value7) {
    ...
    public <X0, X1, X2, X3, X4> Septet<X0, X1, X2, X3, X4, A, B> addAt0(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt0(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(),
                tuple.getValue4());
    }

    public <X0, X1, X2, X3, X4> Septet<A, X0, X1, X2, X3, X4, B> addAt1(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt1(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(),
                tuple.getValue4());
    }

    public <X0, X1, X2, X3, X4> Septet<A, B, X0, X1, X2, X3, X4> addAt2(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt2(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(),
                tuple.getValue4());
    }
    ...
    public <X0, X1, X2, X3, X4, X5, X6, X7> Decade<X0, X1, X2, X3, X4, X5, X6, X7, A, B> addAt0(
        ...
        return addAt0(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(),
                tuple.getValue4(), tuple.getValue5(), tuple.getValue6(), tuple.getValue7());
    }
    ...
    public <X0, X1, X2> Quintet<A, B, X0, X1, X2> add(final X0 value0, final X1 value1,
                                                      final X2 value2) {
    ...
    public <X0, X1, X2, X3> Sextet<A, B, X0, X1, X2, X3> add(final X0 value0, final X1 value1,
                                                             final X2 value2, final X3 value3) {
    ...
    public <X0, X1, X2, X3, X4> Septet<A, B, X0, X1, X2, X3, X4> add(final X0 value0, final X1 value1,
                                                                     final X2 value2, final X3 value3, final X4 value4) {
        return addAt2(value0, value1, value2, value3, value4);
    }

    public <X0, X1, X2, X3, X4> Septet<A, B, X0, X1, X2, X3, X4> add(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt2(tuple);
    }

    public <X0, X1, X2, X3, X4, X5> Octet<A, B, X0, X1, X2, X3, X4, X5> add(final X0 value0,
                                                                            final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
    ...
    public <X0, X1, X2, X3, X4, X5, X6> Ennead<A, B, X0, X1, X2, X3, X4, X5, X6> add(final X0 value0,
                                                                                     final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5,
                                                                                     final X6 value6) {
