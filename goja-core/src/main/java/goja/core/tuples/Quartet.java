package goja.core.tuples;

import goja.core.tuples.valueintf.IValue0;
import goja.core.tuples.valueintf.IValue1;
import goja.core.tuples.valueintf.IValue2;
import goja.core.tuples.valueintf.IValue3;

import java.util.Collection;
import java.util.Iterator;

/**
 * <p> A tuple of four elements. </p>
 *
...
public final class Quartet<A, B, C, D>
    ...
    public static <A, B, C, D> Quartet<A, B, C, D> with(final A value0, final B value1,
                                                        final C value2, final D value3) {
        return new Quartet<A, B, C, D>(value0, value1, value2, value3);
    }

    /**
     * <p> Create tuple from array. Array has to have exactly four elements. </p>
     *
    ...
    public static <X> Quartet<X, X, X, X> fromArray(final X[] array) {
        ...
        if (array.length != 4) {
            throw new IllegalArgumentException(
                    "Array must have exactly 4 elements in order to create a Quartet. Size is "
                            + array.length);
        }
    ...
    /**
     * <p> Create tuple from collection. Collection has to have exactly four elements. </p>
     *
    ...
    /**
     * <p> Create tuple from iterable. Iterable has to have exactly four elements. </p>
     *
    ...
    /**
     * <p> Create tuple from iterable, starting from the specified index. Iterable can have more (or
     * less) elements than the tuple to be created. </p>
     *
     * @param <X>      the iterable component type
     * @param iterable the iterable to be converted to a tuple
     * @return the tuple
    ...
    public <X0, X1, X2> Septet<X0, X1, X2, A, B, C, D> addAt0(final X0 value0, final X1 value1,
                                                              final X2 value2) {
        return new Septet<X0, X1, X2, A, B, C, D>(
                value0, value1, value2, this.val0, this.val1, this.val2, this.val3);
    }

    public <X0, X1, X2> Septet<A, X0, X1, X2, B, C, D> addAt1(final X0 value0, final X1 value1,
                                                              final X2 value2) {
        return new Septet<A, X0, X1, X2, B, C, D>(
                this.val0, value0, value1, value2, this.val1, this.val2, this.val3);
    }

    public <X0, X1, X2> Septet<A, B, X0, X1, X2, C, D> addAt2(final X0 value0, final X1 value1,
                                                              final X2 value2) {
        return new Septet<A, B, X0, X1, X2, C, D>(
                this.val0, this.val1, value0, value1, value2, this.val2, this.val3);
    }

    public <X0, X1, X2> Septet<A, B, C, X0, X1, X2, D> addAt3(final X0 value0, final X1 value1,
                                                              final X2 value2) {
        return new Septet<A, B, C, X0, X1, X2, D>(
                this.val0, this.val1, this.val2, value0, value1, value2, this.val3);
    }

    public <X0, X1, X2> Septet<A, B, C, D, X0, X1, X2> addAt4(final X0 value0, final X1 value1,
                                                              final X2 value2) {
        return new Septet<A, B, C, D, X0, X1, X2>(
                this.val0, this.val1, this.val2, this.val3, value0, value1, value2);
    }

    public <X0, X1, X2, X3> Octet<X0, X1, X2, X3, A, B, C, D> addAt0(final X0 value0, final X1 value1,
    ...
    public <X0, X1, X2, X3, X4, X5> Decade<A, X0, X1, X2, X3, X4, X5, B, C, D> addAt1(final X0 value0,
                                                                                      final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
    ...
    public <X0, X1, X2, X3, X4, X5> Decade<A, B, X0, X1, X2, X3, X4, X5, C, D> addAt2(final X0 value0,
                                                                                      final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
    ...
    public <X0, X1, X2, X3, X4, X5> Decade<A, B, C, X0, X1, X2, X3, X4, X5, D> addAt3(final X0 value0,
                                                                                      final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
    ...
    public <X0, X1, X2, X3, X4, X5> Decade<A, B, C, D, X0, X1, X2, X3, X4, X5> addAt4(final X0 value0,
                                                                                      final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
    ...
    public <X0, X1, X2, X3> Octet<X0, X1, X2, X3, A, B, C, D> addAt0(
            final Quartet<X0, X1, X2, X3> tuple) {
        return addAt0(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3());
    }

    public <X0, X1, X2, X3> Octet<A, X0, X1, X2, X3, B, C, D> addAt1(
            final Quartet<X0, X1, X2, X3> tuple) {
        return addAt1(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3());
    }

    public <X0, X1, X2, X3> Octet<A, B, X0, X1, X2, X3, C, D> addAt2(
            final Quartet<X0, X1, X2, X3> tuple) {
        return addAt2(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3());
    }

    public <X0, X1, X2, X3> Octet<A, B, C, X0, X1, X2, X3, D> addAt3(
            final Quartet<X0, X1, X2, X3> tuple) {
        return addAt3(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3());
    }

    public <X0, X1, X2, X3> Octet<A, B, C, D, X0, X1, X2, X3> addAt4(
            final Quartet<X0, X1, X2, X3> tuple) {
        return addAt4(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3());
    }

    public <X0, X1, X2, X3, X4> Ennead<X0, X1, X2, X3, X4, A, B, C, D> addAt0(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt0(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(),
                tuple.getValue4());
    }

    public <X0, X1, X2, X3, X4> Ennead<A, X0, X1, X2, X3, X4, B, C, D> addAt1(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt1(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(),
                tuple.getValue4());
    }

    public <X0, X1, X2, X3, X4> Ennead<A, B, X0, X1, X2, X3, X4, C, D> addAt2(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt2(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(),
                tuple.getValue4());
    }

    public <X0, X1, X2, X3, X4> Ennead<A, B, C, X0, X1, X2, X3, X4, D> addAt3(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt3(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(),
                tuple.getValue4());
    }

    public <X0, X1, X2, X3, X4> Ennead<A, B, C, D, X0, X1, X2, X3, X4> addAt4(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt4(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(),
                tuple.getValue4());
    }
    ...
    public <X0, X1, X2, X3, X4, X5> Decade<X0, X1, X2, X3, X4, X5, A, B, C, D> addAt0(
        ...
        return addAt0(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(),
                tuple.getValue4(), tuple.getValue5());
    }
    ...
    public <X0, X1, X2> Septet<A, B, C, D, X0, X1, X2> add(final X0 value0, final X1 value1,
                                                           final X2 value2) {
    ...
    public <X0, X1, X2, X3> Octet<A, B, C, D, X0, X1, X2, X3> add(final X0 value0, final X1 value1,
                                                                  final X2 value2, final X3 value3) {
        return addAt4(value0, value1, value2, value3);
    }

    public <X0, X1, X2, X3> Octet<A, B, C, D, X0, X1, X2, X3> add(
            final Quartet<X0, X1, X2, X3> tuple) {
        return addAt4(tuple);
    }

    public <X0, X1, X2, X3, X4> Ennead<A, B, C, D, X0, X1, X2, X3, X4> add(final X0 value0,
                                                                           final X1 value1, final X2 value2, final X3 value3, final X4 value4) {
        return addAt4(value0, value1, value2, value3, value4);
    }

    public <X0, X1, X2, X3, X4> Ennead<A, B, C, D, X0, X1, X2, X3, X4> add(
            final Quintet<X0, X1, X2, X3, X4> tuple) {
        return addAt4(tuple);
    }

    public <X0, X1, X2, X3, X4, X5> Decade<A, B, C, D, X0, X1, X2, X3, X4, X5> add(final X0 value0,
                                                                                   final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
