...
public final class Sextet<A, B, C, D, E, F>
    ...
    public static <A, B, C, D, E, F> Sextet<A, B, C, D, E, F> with(final A value0, final B value1,
                                                                   final C value2, final D value3, final E value4, final F value5) {
        return new Sextet<A, B, C, D, E, F>(value0, value1, value2, value3, value4, value5);
    }

    /**
     * <p> Create tuple from array. Array has to have exactly six elements. </p>
     *
    ...
    public static <X> Sextet<X, X, X, X, X, X> fromArray(final X[] array) {
        ...
        if (array.length != 6) {
            throw new IllegalArgumentException(
                    "Array must have exactly 6 elements in order to create a Sextet. Size is "
                            + array.length);
        }
    ...
    /**
     * <p> Create tuple from collection. Collection has to have exactly six elements. </p>
     *
    ...
    /**
     * <p> Create tuple from iterable. Iterable has to have exactly six elements. </p>
     *
    ...
    public <X0, X1, X2, X3> Decade<A, X0, X1, X2, X3, B, C, D, E, F> addAt1(final X0 value0,
                                                                            final X1 value1, final X2 value2, final X3 value3) {
    ...
    public <X0, X1, X2, X3> Decade<A, B, X0, X1, X2, X3, C, D, E, F> addAt2(final X0 value0,
                                                                            final X1 value1, final X2 value2, final X3 value3) {
    ...
    public <X0, X1, X2, X3> Decade<A, B, C, X0, X1, X2, X3, D, E, F> addAt3(final X0 value0,
                                                                            final X1 value1, final X2 value2, final X3 value3) {
    ...
    public <X0, X1, X2, X3> Decade<A, B, C, D, X0, X1, X2, X3, E, F> addAt4(final X0 value0,
                                                                            final X1 value1, final X2 value2, final X3 value3) {
    ...
    public <X0, X1, X2, X3> Decade<A, B, C, D, E, X0, X1, X2, X3, F> addAt5(final X0 value0,
                                                                            final X1 value1, final X2 value2, final X3 value3) {
    ...
    public <X0, X1, X2, X3> Decade<A, B, C, D, E, F, X0, X1, X2, X3> addAt6(final X0 value0,
                                                                            final X1 value1, final X2 value2, final X3 value3) {
    ...
    public <X0, X1, X2> Ennead<A, B, C, D, E, F, X0, X1, X2> add(final X0 value0, final X1 value1,
                                                                 final X2 value2) {
    ...
    public <X0, X1, X2, X3> Decade<A, B, C, D, E, F, X0, X1, X2, X3> add(final X0 value0,
                                                                         final X1 value1, final X2 value2, final X3 value3) {
        return addAt6(value0, value1, value2, value3);
    }

    public <X0, X1, X2, X3> Decade<A, B, C, D, E, F, X0, X1, X2, X3> add(
            final Quartet<X0, X1, X2, X3> tuple) {
        return addAt6(tuple);
    }
