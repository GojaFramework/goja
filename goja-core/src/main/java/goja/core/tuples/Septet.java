...
public final class Septet<A, B, C, D, E, F, G>
    ...
    public static <A, B, C, D, E, F, G> Septet<A, B, C, D, E, F, G> with(final A value0,
                                                                         final B value1, final C value2, final D value3, final E value4, final F value5,
                                                                         final G value6) {
        return new Septet<A, B, C, D, E, F, G>(value0, value1, value2, value3, value4, value5, value6);
    }

    /**
     * <p> Create tuple from array. Array has to have exactly seven elements. </p>
     *
    ...
    public static <X> Septet<X, X, X, X, X, X, X> fromArray(final X[] array) {
        ...
        if (array.length != 7) {
            throw new IllegalArgumentException(
                    "Array must have exactly 7 elements in order to create a Septet. Size is "
                            + array.length);
        }
    ...
    /**
     * <p> Create tuple from collection. Collection has to have exactly seven elements. </p>
     *
    ...
    /**
     * <p> Create tuple from iterable. Iterable has to have exactly seven elements. </p>
     *
    ...
    private static <X> Septet<X, X, X, X, X, X, X> fromIterable(final Iterable<X> iterable, int index,
        ...
        if (iter.hasNext() && exactSize) {
            throw new IllegalArgumentException(
                    "Iterable must have exactly 7 available elements in order to create a Septet.");
        }
    ...
    public <X0, X1, X2> Decade<X0, X1, X2, A, B, C, D, E, F, G> addAt0(final X0 value0,
                                                                       final X1 value1, final X2 value2) {
        return new Decade<X0, X1, X2, A, B, C, D, E, F, G>(
                value0, value1, value2, this.val0, this.val1, this.val2, this.val3, this.val4, this.val5,
                this.val6);
    }

    public <X0, X1, X2> Decade<A, X0, X1, X2, B, C, D, E, F, G> addAt1(final X0 value0,
                                                                       final X1 value1, final X2 value2) {
    ...
    public <X0, X1, X2> Decade<A, B, X0, X1, X2, C, D, E, F, G> addAt2(final X0 value0,
                                                                       final X1 value1, final X2 value2) {
    ...
    public <X0, X1, X2> Decade<A, B, C, X0, X1, X2, D, E, F, G> addAt3(final X0 value0,
                                                                       final X1 value1, final X2 value2) {
    ...
    public <X0, X1, X2> Decade<A, B, C, D, X0, X1, X2, E, F, G> addAt4(final X0 value0,
                                                                       final X1 value1, final X2 value2) {
    ...
    public <X0, X1, X2> Decade<A, B, C, D, E, X0, X1, X2, F, G> addAt5(final X0 value0,
                                                                       final X1 value1, final X2 value2) {
    ...
    public <X0, X1, X2> Decade<A, B, C, D, E, F, X0, X1, X2, G> addAt6(final X0 value0,
                                                                       final X1 value1, final X2 value2) {
    ...
    public <X0, X1, X2> Decade<A, B, C, D, E, F, G, X0, X1, X2> addAt7(final X0 value0,
                                                                       final X1 value1, final X2 value2) {
    ...
    public <X0, X1, X2> Decade<X0, X1, X2, A, B, C, D, E, F, G> addAt0(
            final Triplet<X0, X1, X2> tuple) {
        return addAt0(tuple.getValue0(), tuple.getValue1(), tuple.getValue2());
    }

    public <X0, X1, X2> Decade<A, X0, X1, X2, B, C, D, E, F, G> addAt1(
            final Triplet<X0, X1, X2> tuple) {
        return addAt1(tuple.getValue0(), tuple.getValue1(), tuple.getValue2());
    }

    public <X0, X1, X2> Decade<A, B, X0, X1, X2, C, D, E, F, G> addAt2(
            final Triplet<X0, X1, X2> tuple) {
        return addAt2(tuple.getValue0(), tuple.getValue1(), tuple.getValue2());
    }

    public <X0, X1, X2> Decade<A, B, C, X0, X1, X2, D, E, F, G> addAt3(
            final Triplet<X0, X1, X2> tuple) {
        return addAt3(tuple.getValue0(), tuple.getValue1(), tuple.getValue2());
    }

    public <X0, X1, X2> Decade<A, B, C, D, X0, X1, X2, E, F, G> addAt4(
            final Triplet<X0, X1, X2> tuple) {
        return addAt4(tuple.getValue0(), tuple.getValue1(), tuple.getValue2());
    }

    public <X0, X1, X2> Decade<A, B, C, D, E, X0, X1, X2, F, G> addAt5(
            final Triplet<X0, X1, X2> tuple) {
        return addAt5(tuple.getValue0(), tuple.getValue1(), tuple.getValue2());
    }

    public <X0, X1, X2> Decade<A, B, C, D, E, F, X0, X1, X2, G> addAt6(
            final Triplet<X0, X1, X2> tuple) {
        return addAt6(tuple.getValue0(), tuple.getValue1(), tuple.getValue2());
    }

    public <X0, X1, X2> Decade<A, B, C, D, E, F, G, X0, X1, X2> addAt7(
            final Triplet<X0, X1, X2> tuple) {
    ...
    public <X0, X1, X2> Decade<A, B, C, D, E, F, G, X0, X1, X2> add(final X0 value0, final X1 value1,
                                                                    final X2 value2) {
