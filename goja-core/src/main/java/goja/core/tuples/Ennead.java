...
public final class Ennead<A, B, C, D, E, F, G, H, I>
    ...
    public static <A, B, C, D, E, F, G, H, I> Ennead<A, B, C, D, E, F, G, H, I> with(final A value0,
                                                                                     final B value1, final C value2, final D value3, final E value4, final F value5,
                                                                                     final G value6, final H value7, final I value8) {
        return new Ennead<A, B, C, D, E, F, G, H, I>(value0, value1, value2, value3, value4, value5,
                value6, value7, value8);
    }

    /**
     * <p> Create tuple from array. Array has to have exactly nine elements. </p>
     *
    ...
    public static <X> Ennead<X, X, X, X, X, X, X, X, X> fromArray(final X[] array) {
        ...
        if (array.length != 9) {
            throw new IllegalArgumentException(
                    "Array must have exactly 9 elements in order to create an Ennead. Size is "
                            + array.length);
        }
    ...
    /**
     * <p> Create tuple from collection. Collection has to have exactly nine elements. </p>
     *
     * @param <X>        the collection component type
     * @param collection the collection to be converted to a tuple
     * @return the tuple
     */
    public static <X> Ennead<X, X, X, X, X, X, X, X, X> fromCollection(
            final Collection<X> collection) {
        return fromIterable(collection);
    }

    /**
     * <p> Create tuple from iterable. Iterable has to have exactly nine elements. </p>
     *
    ...
    private static <X> Ennead<X, X, X, X, X, X, X, X, X> fromIterable(final Iterable<X> iterable,
        ...
        if (iter.hasNext() && exactSize) {
            throw new IllegalArgumentException(
                    "Iterable must have exactly 9 available elements in order to create an Ennead.");
        }
