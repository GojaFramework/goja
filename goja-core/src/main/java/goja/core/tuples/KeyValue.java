...
import goja.core.tuples.valueintf.IValueKey;
...
/**
 * <p> A tuple of two elements, with positions 0 and 1 renamed as "key" and "value", respectively.
 * </p>
 *
...
public final class KeyValue<A, B>
    ...
    public static <X> KeyValue<X, X> fromArray(final X[] array) {
        ...
        if (array.length != 2) {
            throw new IllegalArgumentException(
                    "Array must have exactly 2 elements in order to create a KeyValue. Size is "
                            + array.length);
        }
    ...
    private static <X> KeyValue<X, X> fromIterable(final Iterable<X> iterable, int index,
