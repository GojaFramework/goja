...
/**
 * Implementation of {@linkRowTransformer} interface for duplicating a collection row
...
public class CollectionRowTransformer extends BaseRowTransformer {
     ...
     * @param sheetTransformer - {@linkSheetTransformer} to use when processing Row Collections
