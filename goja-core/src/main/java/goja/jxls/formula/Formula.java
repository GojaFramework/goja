...
public class Formula {
    ...
    private Set<Object> cellRefs = Sets.newHashSet();

    private List<Object> formulaParts = Lists.newArrayList();
    ...
    public boolean isInline() {
        return formula.contains(inlineFormulaToken);
    }
    ...
    public String getActualFormula() {
        ...
        for (Object formulaPart1 : formulaParts) {
            formulaPart = (FormulaPart) formulaPart1;
            actualFormulaBuilder.append(formulaPart.getActualFormula());
        }
        return actualFormulaBuilder.toString();
    }

    public Set<Object> findRefCells() {
        Set<Object> refCells = Sets.newHashSet();
        for (Object formulaPart1 : formulaParts) {
            FormulaPart formulaPart = (FormulaPart) formulaPart1;
...
//        formulaParts.clear();
    ...
    private static class FormulaInfo {
        private FormulaInfo(final Formula formula) {
            this.formulaParts = Lists.newLinkedList();
            this.cellRefs = Sets.newHashSet();
        ...
        private List<Object> formulaParts;
        private Set<Object>  cellRefs;
    }
}
