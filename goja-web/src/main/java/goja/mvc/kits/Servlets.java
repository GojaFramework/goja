...
public class Servlets {
    ...
    public static void setExpiresHeader(HttpServletResponse response, long expiresSeconds) {
        ...
        response.setDateHeader(HttpHeaders.EXPIRES, System.currentTimeMillis() + (expiresSeconds
                * 1000));
    ...
    /**
     * 根据浏览器If-Modified-Since Header, 计算文件是否已被修改. <p/> 如果无修改, checkIfModify返回false ,设置304 not modify
     * status.
     *
    ...
    /**
     * 根据浏览器 If-None-Match Header, 计算Etag是否已无效. <p/> 如果Etag有效, checkIfNoneMatch返回false, 设置304 not
     * modify status.
     *
     * @param etag 内容的ETag.
     */
    ...
    public static void setFileDownloadHeader(HttpServletResponse response, String fileName) {
        try {
            ...
            response.setHeader(HttpHeaders.CONTENT_DISPOSITION,
                    "attachment; filename=\"" + encodedfileName + StringPool.QUOTE);
