...
public class Enhancer {
    ...
    private static final ConcurrentHashMap<String, Object> singleton =
    ...
    public static <T> T enhance(Class<T> targetClass, Class<? extends Interceptor> injectIntersClass1,
    ...
    public static <T> T enhance(Class<T> targetClass, Class<? extends Interceptor> injectIntersClass1,
        ...
        return (T) enhance(targetClass,
                createInjectInters(injectIntersClass1, injectIntersClass2, injectIntersClass3));
    }
    ...
    public static <T> T enhance(Object target, Interceptor... injectInters) {
        return (T) net.sf.cglib.proxy.Enhancer.create(target.getClass(),
                new Callback(target, injectInters));
    }
    ...
    public static <T> T enhance(Object target, Class<? extends Interceptor> injectIntersClass1,
                                Class<? extends Interceptor> injectIntersClass2) {
    ...
    private static Interceptor[] createInjectInters(
            Class<? extends Interceptor>... injectInterClasses) {
