...
public class Duang {
    ...
    public static <T> T duang(Class<T> targetClass, Class<? extends Interceptor> injectIntersClass1,
    ...
    public static <T> T duang(Object target, Class<? extends Interceptor> injectIntersClass1,
                              Class<? extends Interceptor> injectIntersClass2) {
