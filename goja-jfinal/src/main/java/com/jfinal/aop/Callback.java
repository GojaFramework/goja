...
class Callback implements MethodInterceptor {
    ...
    public Object intercept(Object target, Method method, Object[] args, MethodProxy methodProxy)
        ...
        if (this.injectTarget != null) {
            ...
            Interceptor[] finalInters =
                    interMan.buildServiceMethodInterceptor(injectInters, target.getClass(), method);
            ...
            Interceptor[] finalInters =
                    interMan.buildServiceMethodInterceptor(injectInters, targetClass, method);
            Invocation invocation = new Invocation(target, method, args, methodProxy, finalInters);
