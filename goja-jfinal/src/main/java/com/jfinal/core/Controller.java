...
public abstract class Controller {
     ...
     */
    public Controller setCookie(String name, String value, int maxAgeInSeconds, String path,
                                String domain, boolean isHttpOnly) {
    ...
    private Controller doSetCookie(String name, String value, int maxAgeInSeconds, String path,
                                   String domain, Boolean isHttpOnly) {
    ...
    public String getPara(int index) {
        ...
        if (urlParaArray == null) {
            if (urlPara == null || "".equals(
                    urlPara))  // urlPara maybe is "" see ActionMapping.getAction(String)
            {
    ...
    public UploadFile getFile(String parameterName, String uploadPath, Integer maxPostSize,
                              String encoding) {
    ...
    public void renderJson(Object object) {
        render =
                object instanceof JsonRender ? (JsonRender) object : renderFactory.getJsonRender(object);
    }
