 ...
 * @since JDK 1.6
 */
public class SnakerKit {

    private static Map<Class<? extends NodeModel>, String> mapper = Maps.newHashMap();
    ...
    public static String getModelJson(ProcessModel model) {
        StringBuilder buffer = new StringBuilder();
        List<TransitionModel> tms = Lists.newArrayList();
