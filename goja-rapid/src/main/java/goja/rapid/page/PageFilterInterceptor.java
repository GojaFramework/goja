...
/**
 * <p> 查询分页过滤器. <p/> usage: <code> <form> <input type="text" name="s-username"> <input type="text"
 * name="s-create-time-between"> <input type="text" name="s-create-time-and"> </form> </code> </p>
 *
 * @author sagyf yang
