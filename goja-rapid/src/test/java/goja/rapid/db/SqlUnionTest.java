...
public class SqlUnionTest {
    ...
    public void testOrderBy() throws Exception {
        final SqlSelect first_select = SqlSelect.create().select("f1,f2").from("t1").andWhere("f1=2").orderBy("order desc");
    ...
    public void testUnion() throws Exception {
        final SqlSelect first_select = SqlSelect.create().select("f1,f2").from("t1").andWhere("f1=2").orderBy("order desc");
        final SqlSelect sencond_select = SqlSelect.create().select("f1,f2").from("t2").andWhere("f2=2").orderBy("order desc");
